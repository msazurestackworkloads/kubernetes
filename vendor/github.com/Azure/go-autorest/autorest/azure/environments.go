...
type Environment struct {
	...
	ArmComputeAPIVersion           string `json:"armComputeAPIVersion"`
	ArmNetworkAPIVersion           string `json:"armNetworkAPIVersion"`
	ArmNetworkScaleSetAPIVersion   string `json:"armNetworkScaleSetAPIVersion"`
	ArmStorageAPIVersion           string `json:"armStorageAPIVersion"`
	ArmDiskAPIVersion              string `json:"armDiskAPIVersion"`
	StorageAPIVersion              string `json:"storageAPIVersion"`
	ArmContainerRegistryAPIVersion string `json:"armContainerRegistryAPIVersion"`
}
...
var (
	...
	PublicCloud = Environment{
		...
		ArmComputeAPIVersion:           "2016-04-30-preview",
		ArmNetworkAPIVersion:           "2017-03-01",
		ArmNetworkScaleSetAPIVersion:   "2016-09-01",
		ArmStorageAPIVersion:           "2016-12-01",
